...
export default function TopHeader() {
  ...
  return (
    ...
    >
      ...
      {/* Search bar */}
      <div
        className="flex-1 flex items-center gap-2 rounded-full px-3 transition-all duration-200"
        style={{
          height: 36,
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        ...
        <button
          id="header-profile"
          className="flex items-center justify-center w-9 h-9 rounded-full font-bold text-xs text-white flex-shrink-0"
